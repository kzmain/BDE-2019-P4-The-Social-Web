console.log(true_data_estimation_hillary.length);
console.log(true_data_estimation_trump.length);
console.log(false_data_estimation_hillary.length);
console.log(false_data_estimation_trump.length);
// --------System Level Config --------
...
let false_title_estimation_top = 260;
let false_title_estimation_lef = left_center;

let false_grid_estimation_lef = left_center;
let false_grid_estimation_top = 300;
let false_grid_estimation_hei = 100;
let false_grid_estimation_wid = "84%";

let true_legend_estimation_top = 420;
let true_legend_estimation_lef = left_center;

let true_title_top_twitter_count_top = 460;
let true_title_top_twitter_count_lef = left_center;

let true_grid_top_twitter_count_top = 500;
...
let true_legend_top_twitter_count_top = 620;
let true_legend_top_twitter_count_lef = left_center;

let true_title_sentiment_analysis_top = 660;
let true_title_sentiment_analysis_lef = left_center;

let true_grid_sentiment_analysis_hillary_top = 700;
...
let true_grid_sentiment_analysis_trump_top = 750;
...
let true_visual_map_sentiment_analysis_top = 700;
...
let false_title_estimation         = {
    text: 'Election Estimation (Normal Twitter based)',
    textStyle:{
        color: '#eee',
        fontSize: title_2_size
    },
    top:  false_title_estimation_top,
...
let false_grid_estimation_index                = 4;
...
let false_grid_estimation                = {
    left:   false_grid_estimation_lef,
    top:    false_grid_estimation_top,
    height: false_grid_estimation_hei,
    width:  false_grid_estimation_wid,
};
let true_grid_list = [
...
let false_xAxis_estimation_index                = 4;
...
let false_xAxis_estimation                 = {
    data: true_x_axis_data,
    type: 'category',
    gridIndex: false_grid_estimation_index,
    axisLine: {
        onZero: true,
        lineStyle: {
                color: '#eee'
...
let false_yAxis_estimation_index                = 4;
...
let false_series_election_estimation_hillary = {
    name: 'Hillary wins',
    xAxisIndex: false_xAxis_estimation_index,
    yAxisIndex: false_yAxis_estimation_index,
    type: 'bar',
    color: "blue",
    stack: 'four',
    emphasis: true_emphasis_style,
    data: false_data_estimation_hillary
};
let false_series_election_estimation_trump   = {
    name: 'Trump wins',
    xAxisIndex: false_xAxis_estimation_index,
    yAxisIndex: false_yAxis_estimation_index,
    type: 'bar',
    ...
    stack: 'four',
    emphasis: true_emphasis_style,
    data: false_data_estimation_trump
};
let true_series_list = [
        ...
        false_series_election_estimation_hillary,
        false_series_election_estimation_trump
    ];
...
true_chart.on("click", function(param){
    if(param.componentSubType === "wordCloud"){
        ...
        console.log(param);
        let n_url = "https://www.google.com/search?q=" + param.data.name;
        n_url = n_url.replace(" ", "+");
        window.open(n_url);
    }
